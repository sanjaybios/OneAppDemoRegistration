...
@IBAction func oK(_ sender: UIButton) {
    ...
    if okButton.isSelected==false {
        let alert = UIAlertController(title: "Important", message: "Please read all the terms and conditions before you agree", preferredStyle: .alert)
